...
// En el body se envía el item deseado, el id de partida el id del jugador, también almacenado en una teórica cookie
// Inspiración
...
router.post("tienda.comprar", "/comprar", async(ctx) => {
    try {
        ...
        const saldo = await ctx.orm.Jugador.decrement(updateBilletera, {where: {id: ctx.request.body.jugadorId}}).then()
